...
private fun ArticleCard(
    ...
    Column(modifier = Modifier, horizontalAlignment = Alignment.Start) {
        ...
        Text(text = shortDescription, fontSize = 16.sp, modifier = Modifier.padding(horizontal = 16.dp), textAlign = TextAlign.Justify)
        Text(text = longDescription, fontSize = 16.sp, modifier = Modifier.padding(16.dp))
    }
}
